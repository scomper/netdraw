...
**标注线** — 独立于设备连线的自由标注曲线，用于在拓扑图上添加说明性箭头和注释。支持抛物线曲线（3 点自动生成 C 曲线）、中间点添加/移除、整体拖拽、属性面板管理。标注线始终渲染在最上层。

**分享链接** — 一键生成分享链接，将当前拓扑图以只读模式分享给他人。对方打开链接即可查看，无需注册。链接 24 小时有效后自动清理，每 IP 每小时最多分享 10 次。
